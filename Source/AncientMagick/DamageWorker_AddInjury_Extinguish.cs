...
{
    class DamageWorker_AddInjury_Extinguish : DamageWorker
    {
        public override float Apply(DamageInfo dinfo, Thing thing)
        {
            ...
            private struct LocalInjuryResult
            {
                ...
                public static DamageWorker_AddInjury_Extinguish.LocalInjuryResult MakeNew()
                {
                    return new DamageWorker_AddInjury_Extinguish.LocalInjuryResult
                    {
                        wounded = false,
                        headshot = false,
                        deflected = false,
            ...
            private float ApplyToPawn(DamageInfo dinfo, Pawn pawn)
            {
                ...
                DamageWorker_AddInjury_Extinguish.LocalInjuryResult localInjuryResult = DamageWorker_AddInjury_Extinguish.LocalInjuryResult.MakeNew();
                ...
                {
                    DamageWorker_AddInjury_Extinguish.PlayWoundedVoiceSound(dinfo, pawn);
                    pawn.Drawer.Notify_DamageApplied(dinfo);
                    DamageWorker_AddInjury_Extinguish.InformPsychology(dinfo, pawn);
                }
            ...
            private bool FragmentDamageForDamageType(DamageInfo dinfo, Pawn pawn, ref DamageWorker_AddInjury_Extinguish.LocalInjuryResult result)
            {
            ...
            private void CheckDuplicateSmallPawnDamageToPartParent(DamageInfo dinfo, Pawn pawn, ref DamageWorker_AddInjury_Extinguish.LocalInjuryResult result)
            {
                if (!dinfo.AllowDamagePropagation)
                {
                    return;
                ...
                {
                    DamageInfo dinfo2 = dinfo;
                    List<HediffDef> hediffs = null;
                    BodyPartDamageInfo part = new BodyPartDamageInfo(result.lastHitPart.parent, false, hediffs);
                    dinfo2.SetPart(part);
                    this.ApplyDamagePartial(dinfo2, pawn, ref result);
                }
            }

            private void ApplyDamagePartial(DamageInfo dinfo, Pawn pawn, ref DamageWorker_AddInjury_Extinguish.LocalInjuryResult result)
            {
                BodyPartRecord exactPartFromDamageInfo = DamageWorker_AddInjury_Extinguish.GetExactPartFromDamageInfo(dinfo, pawn);
                ...
                if (DamageWorker_AddInjury_Extinguish.IsHeadshot(dinfo, hediff_Injury, pawn))
                {
            ...
            private void FinalizeAndAddInjury(Pawn pawn, Hediff_Injury injury, DamageInfo dinfo, ref DamageWorker_AddInjury_Extinguish.LocalInjuryResult result)
            {
            ...
            private void CheckPropagateDamageToInnerSolidParts(DamageInfo dinfo, Pawn pawn, Hediff_Injury injury, bool involveArmor, ref DamageWorker_AddInjury_Extinguish.LocalInjuryResult result)
            {
                if (!dinfo.AllowDamagePropagation)
                {
                    return;
            ...
            private void CheckDuplicateDamageToOuterParts(DamageInfo dinfo, Pawn pawn, Hediff_Injury injury, bool involveArmor, ref DamageWorker_AddInjury_Extinguish.LocalInjuryResult result)
            {
                if (!dinfo.AllowDamagePropagation)
                {
                    return;
